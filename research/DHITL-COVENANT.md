...
This document is a covenant-layer amendment to **DHITL — Democratic Humans In The Loop**.

Its role is not to replace the legal license of the corpus or code. Its role is to state the democratic conditions under which a person, organization, project, fork, platform, institution, or technical system may legitimately claim to act in the spirit of DHITL.

The legal licenses preserve the commons. This covenant preserves the democratic meaning of the commons.

In French:

> Les licences protègent le commun contre la fermeture.  
> Le covenant protège le sens démocratique du commun contre l'usurpation.

## 1. Core invariant

The democratic invariant of DHITL is:

> **One living person, one voice. Only the living vote.**

French canonical form:

> **Une personne vivante, une voix. Seuls les vivants votent.**

This is the operational form of the broader principle sometimes expressed as **One Human, One Voice** or **one person, one vote**.

The addition of "living" is not decorative. It closes a structural ambiguity introduced by AI agents, digital twins, corporations, foundations, DAOs, automated delegates, inherited mandates, memorial agents, and other non-living or supra-personal decision structures.

## 2. Living-person sovereignty condition

DHITL requires that democratic authority remains attached to living human persons.

Artificial agents, digital twins, models, corporations, foundations, DAOs, automated delegates, legal persons, memorial systems, or any other non-living entity may assist deliberation, produce suggestions, audit processes, simulate consequences, preserve memory, execute delegated technical tasks, or help a living person understand a decision.

They may not hold sovereign voting rights.

They may not receive an autonomous political mandate.

They may not substitute their own decision for the living person's judgment.
...
- preserving and querying memory;
- helping a living person deliberate more effectively.

Prohibited sovereign roles:

- voting as an agent;
- holding a political mandate;
- acting as a legal-political representative without explicit living-person control;
- creating extra voting weight through bot swarms, synthetic persons, or delegated autonomous accounts;
- converting probabilistic preference inference into binding political choice.

Short rule:

> **AI may illuminate judgment. It must not replace sovereignty.**
...
However, any project claiming to be **DHITL-compatible**, **Democratic Humans In The Loop compatible**, **Kudocracy-compatible**, or otherwise aligned with the DHITL democratic layer should publicly adhere to this covenant.

Such public adherence means, at minimum, accepting the following statements:
...
| Layer | Function | Suitable instrument |
|---|---|---|
| Code | Prevent proprietary closure of operational capacity | AGPL-3.0-or-later for networked platforms; GPL/LGPL/MPL where appropriate |
| Texts and doctrine | Preserve attribution and share-alike transmission | CC BY-SA 4.0 |
| Databases and structured traces | Preserve reciprocal openness of adapted databases | ODbL 1.0 or equivalent database copyleft |
| Names, labels, compatibility claims | Prevent democratic usurpation and false officiality | Trademark policy, certification rules, covenant adherence |
| Governance behavior | Make anti-capture principles explicit and auditable | DHITL Covenant |

The covenant is therefore not primarily an exclusion mechanism. It is a truthfulness mechanism.
...
> **Reuse the commons. Do not capture the vote.**

French:

> **Réutilisez le commun. Ne capturez pas le vote.**
...
*Institut Mariani, Corte, Corsica — 2026-06-23*  
